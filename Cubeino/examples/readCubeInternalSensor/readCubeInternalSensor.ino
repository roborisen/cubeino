...
void loop()
{
  ...
  get_cube_acc_value(sensor_data, 0, myCubeSerial); //1번 큐브의 가속도센서 값을 가져온다.
  Serial.print("acc-X:");
  Serial.print((int8_t)sensor_data[1]);
  Serial.print(" acc-Y:");
  Serial.print((int8_t)sensor_data[2]);
  Serial.print(" *** ");

  get_cube_proxi_value(sensor_data, 0, myCubeSerial); //0번 큐브의 근접센서 값을 가져온다.
  Serial.print(" Proximity value:");
  Serial.print(sensor_data[2]);
  Serial.print(" *** ");

  get_cube_button_value(sensor_data, 1, myCubeSerial); //1번 큐브의 버튼 상태 값을 가져온다.
