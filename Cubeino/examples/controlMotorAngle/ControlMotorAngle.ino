...
void loop()
{
    if(Serial.available()){
      ...
      if(c == '0'){
        send_a_cube_angle(0, 300, myCubeSerial);
      }else if(c == '1'){
        send_a_cube_angle(1, 300, myCubeSerial);
      }else if(c == '2'){
        send_a_cube_angle(0, -300, myCubeSerial);
      }else if(c == '3'){
        send_a_cube_angle(1, -300, myCubeSerial);
        ...
        send_multi_cube_angle(GCUBE_TOTAL, 500, 500, 0, 0, myCubeSerial); // G0: 500, G1: 500, G2: 0, G3:0
      }
	}
}